(function () {
	...
	angular.module('rheas').constant('settings', {
		...
		menus: [
			{
				'name': 'HOW_TO_USE',
				'url': 'https://docs.google.com/document/d/1rDAkJKNfil_DwZ5DDcq2a2vBFBob6_grVYuuQ2Hwk2M/edit?usp=sharing',
				'show': false,
				'target': '_blank'
			},
			{
				'name': 'DOCUMENT',
				'url': 'https://docs.google.com/document/d/1wnWy_FmmRdiaff75pLoFYwzOFR6YQss4_TcouNSpib4/edit?usp=sharing ',
				'show': true,
				'target': '_blank'
			},
			{
				'name': 'FEEDBACK',
				'url': 'https://docs.google.com/forms/d/e/1FAIpQLSc6k7Qh6gIGsYp0PYvUMsjXyGqTgpcuvwvGW1EuUfy9UhD3sg/viewform?usp=sf_link',
				'show': true,
				'target': '_blank'
			}
		],
		...
		partnersHeader: [
			{
				'alt': 'Ministry of Agricultural, Livastock and Irrigation',
				'url': 'https://moali.gov.mm/',
				'src': '/modules/core/client/img/MOALI.png',
				'className': 'moali',
				'text': 'block'
			},
			{
